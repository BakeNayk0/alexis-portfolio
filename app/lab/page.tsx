      ...
      <Card className="border-primary/10 bg-card/50 backdrop-blur-sm">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-foreground">Backend Status</h2>
          </div>
          <Badge variant={isOk ? "default" : "destructive"} className="px-3">
            <span className="flex items-center gap-1.5">
              <span className={`h-2 w-2 rounded-full ${isOk ? 'bg-emerald-500 animate-pulse' : 'bg-destructive'}`} />
    ...
    return (
      <Card className="border-destructive/20 bg-destructive/5">
        ...
        <p className="text-sm text-muted-foreground">
          Unable to reach the backend service. {error instanceof Error ? error.message : 'Unknown error occurred.'}
        </p>
      </Card>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-10 text-center lg:text-left">
        <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Lab</h1>
      ...
      <div className="grid gap-8">
        ...
        <div className="rounded-xl border border-dashed border-border p-8 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-base font-semibold text-foreground">More coming soon</h3>
